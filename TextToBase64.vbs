' TextToBase64.vbs
' VBScript program to convert a text string into a base64 encoded string.
'
' ----------------------------------------------------------------------
...
'
' Syntax:
'     cscript //nologo TextToBase64.vbs <text string>
' where:
'     <text string> is a text string. If the string contains spaces, or
...
If (Wscript.Arguments.Count <> 1) Then
    strValue = InputBox("Enter text string to be encoded", "TextToBase64.vbs")
Else
...
' Convert text string into hexadecimal bytes.
...
Sub Syntax()
    ...
    Wscript.Echo "Syntax:"
    Wscript.Echo "  cscript //nologo TextToBase64.vbs <text string>"
    Wscript.Echo "where:"
    Wscript.Echo "  <text string> is a text string. Enclose the string in"
    Wscript.Echo "      quotes if it has spaces or "">"" or ""|"" characters."
    Wscript.Echo "For example:"
    Wscript.Echo "  cscript //nologo TextToBase64.vbs ""This is a test"""
End Sub